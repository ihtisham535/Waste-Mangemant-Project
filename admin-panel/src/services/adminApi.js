const API_BASE_URL = import.meta.env.VITE_ADMIN_API_BASE_URL || "http://localhost:5000";
...
export const deleteShop = (id) =>
  request(`/admin/shops/${id}`, { method: "DELETE" });
...
export const deleteShopkeeper = (id) =>
  request(`/admin/shopkeepers/${id}`, { method: "DELETE" });
